...
/:slug/manage              대시보드 (RequireAdmin → AdminLayout)
  └ requests · list · add · facilities · edit/:resId
```
...
- **AdminLayout**: 기관 short_name 표시, slug 접두 nav(대시보드/승인요청/목록/직접추가/**시설관리**), 로그아웃.
